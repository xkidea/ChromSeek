...
try:
    # Package import: used when loading through ``utils.model_2kb_1d``.
    from .cc6_200bp import ConvBlock, ResidualBlock, PositionalEncoding
except ImportError:
    # Fallback for direct script-style imports with ``utils`` on sys.path.
    from cc6_200bp import ConvBlock, ResidualBlock, PositionalEncoding
import os
...
if __name__ == "__main__":
    pretrained_path_default = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'checkpoints', 'best_model_448k_200bp.pth')
