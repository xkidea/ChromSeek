...
from pretraining.model import StrongFusionModel_V4
...
def main():
    ...
    task_dir = Path(__file__).resolve().parent
    project_root = task_dir.parent
    dataset_path = task_dir / 'sample_data.pt'
    ckpt_path = project_root / 'checkpoints' / 'chromSeek_hic_enhancement.pth'
